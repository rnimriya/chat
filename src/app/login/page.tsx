...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-zinc-950 transition-colors">
      {/* Left brand panel */}
      <div className="hidden lg:flex flex-col justify-between w-[440px] shrink-0 p-12 relative overflow-hidden" style={{ background: "linear-gradient(155deg, #ede9fe 0%, #ddd6fe 50%, #c4b5fd 100%)" }}>
        <div className="relative z-10">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-xl text-zinc-900">paperchat</span>
          </Link>
        </div>
        <div className="relative z-10">
          <h2 className="text-3xl font-extrabold text-zinc-900 leading-tight tracking-tight mb-4">Welcome back.<br />Your bots missed you.</h2>
          <p className="text-zinc-600 text-sm leading-relaxed">Sign in to manage your chatbots, view analytics, and keep your AI support team running.</p>
        </div>
        <div className="relative z-10 bg-white/60 backdrop-blur-sm border border-white/80 rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div><div className="text-zinc-900 text-sm font-semibold">Sarah K.</div><div className="text-zinc-500 text-xs">Head of Support, Acme Inc.</div></div>
          </div>
          <p className="text-zinc-700 text-sm italic leading-relaxed">&ldquo;PaperChat cut our support ticket volume by 60% in the first week.&rdquo;</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white dark:bg-zinc-950">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-extrabold text-zinc-900 dark:text-zinc-100 tracking-tight">Sign in to your account</h1>
            <p className="text-zinc-500 dark:text-zinc-400 mt-1.5 text-sm">Enter your credentials below to continue</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div className="flex items-center gap-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 text-sm px-3.5 py-3 rounded-xl">
            ...
            <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-2 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-semibold py-2.5 rounded-xl hover:bg-zinc-700 dark:hover:bg-zinc-100 disabled:opacity-60 transition-colors mt-2">
          ...
          <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-6">
            ...
            <Link href="/signup" className="text-sky-500 dark:text-sky-400 font-semibold hover:text-sky-600">Sign up free</Link>
          </p>
