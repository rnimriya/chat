  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-zinc-950 transition-colors">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[440px] shrink-0 p-12 relative overflow-hidden" style={{ background: "linear-gradient(155deg, #ede9fe 0%, #ddd6fe 50%, #c4b5fd 100%)" }}>
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-extrabold text-zinc-900 leading-tight tracking-tight mb-4">Build your AI support team in minutes.</h2>
          <p className="text-zinc-600 text-sm leading-relaxed mb-8">Join thousands of businesses that have replaced their static FAQ pages with a smart AI agent.</p>
          <ul className="space-y-3.5">
            {perks.map((perk) => (
              <li key={perk} className="flex items-center gap-3 text-slate-800 text-sm">
        ...
        <div className="relative z-10 text-xs text-zinc-500">Free to start · No credit card required</div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white dark:bg-zinc-950">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-extrabold text-zinc-900 dark:text-zinc-100 tracking-tight">Create your account</h1>
          ...
          <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-6">
            ...
            <Link href="/login" className="text-sky-500 dark:text-sky-400 font-semibold hover:text-sky-600">Sign in</Link>
          </p>
